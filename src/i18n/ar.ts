    ...
    team: {
      ...
      members: {
        ...
        elvina: {
          ...
          role: "مدير الجودة",
          description:
            "عملت إلفينا كممرضة منذ عام ٢٠٠٨، وتتمتع بخبرة واسعة في مجالات مختلفة بقطاع الرعاية الصحية. وقد أكسبتها خبرتها المهنية الطويلة فهمًا عميقًا لهيكلية العمل واحتياجات الأفراد الفردية. تعمل إلفينا بدافع التطوير والتغيير، ولديها رغبة قوية في بناء مؤسسات تتكامل فيها الجودة والأمان والالتزام. بصفتها مديرة الجودة في أليريو أومسورج، تحرص إلفينا على بناء مؤسسة يشعر فيها كل من الموظفين والعملاء بالاهتمام والمشاركة والفخر بكونهم جزءًا لا يتجزأ منها. بفضل مزيجها من الاحترافية والود والوضوح، تساهم إلفينا في أن تقدم أليريو أومسورج دائمًا رعايةً مخلصة وعالية الجودة ومحترمة.",
          email: "",
        },
        haris: {
          name: "هاريس",
        ...
        perihan: {
          ...
          role: "المنظم",
          description:
            "منسقة ذات خبرة في مجال الرعاية المنزلية، مع التركيز على التوثيق وخطط التنفيذ وفقًا لمعايير IBIC. خبرة في العمل على نظام تشغيل Treserva/Lifecare. بالنسبة لي، لا يقتصر التوثيق على الإجراءات الروتينية فحسب، بل يشمل أيضًا حماية سلامة المستخدمين وحقهم في رعاية جيدة.",
          email: "",
        },
      },
    },
